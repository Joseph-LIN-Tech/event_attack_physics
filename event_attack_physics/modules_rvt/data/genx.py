...
from data_rvt.genx_utils.collate import custom_collate_rnd, custom_collate_streaming
from data_rvt.genx_utils.dataset_rnd import build_random_access_dataset, get_weighted_random_sampler, CustomConcatDataset
from data_rvt.genx_utils.dataset_streaming import build_streaming_dataset
from data_rvt.utils.spatial import get_dataloading_hw
from data_rvt.utils.types import DatasetMode, DatasetSamplingMode
...
class DataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        # Returns a mapping from data_rvtset sampling modes to dataloader.
        return train_loaders
