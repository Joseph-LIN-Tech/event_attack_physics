...
def split_image_to_a4(image_path, output_path, size_mm= 1000, dpi=300):
    ...
    target_size_mm = (size_mm, size_mm)  # 1 meter x 1 meter in millimeters
    ...
    for j in range(pages_y):
        for i in range(pages_x):
            ...
            a4_image = resized_image.crop((left, upper, right, lower))
...
output_paths = split_image_to_a4(image_path,output_path,size_mm=500)
