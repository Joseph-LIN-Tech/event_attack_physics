...
class MyTransform(object):
    ...
    '''
    def __init__(self, args, reshape_size=None, crop_size=None , augment=False, debug_mode=False, train_mode=False): 
        ...
        self.log_threshold = self.args['log_threshold']
        
        self.args['min_translate_x'] = 0
        self.args['min_translate_y'] = 0
        self.args['min_angle_z'] = 0
        #self.args = args
    ...
    def __call__(self, irradiance_map):
...
class MyOpticFlows():
    ...
    def __init__(self, args): 
        ...
        [irradiance_map_height, irradiance_map_width] = self.args['reshape_size']
        x = np.array([i for i in range(irradiance_map_width)])
        y = np.array([i for i in range(irradiance_map_height)])
