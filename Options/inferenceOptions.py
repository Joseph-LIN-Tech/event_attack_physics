...
class InferenceOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--frame_num', default=3, help='resize the image')
        #self.parser.add_argument('--reshape-size', default=(346,260), help='resize the image')
        self.parser.add_argument('--size', default=(640,640), help='crop the image')
        ...
        self.parser.add_argument('--contrast_threshold_pos', type=float, default=0.05)
        self.parser.add_argument('--contrast_threshold_neg', type=float, default=0.05)
