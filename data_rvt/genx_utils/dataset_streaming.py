...
from data_rvt.genx_utils.sequence_for_streaming import SequenceForIter, RandAugmentIterDataPipe
from data_rvt.utils.stream_concat_datapipe import ConcatStreamingDataPipe
from data_rvt.utils.stream_sharded_datapipe import ShardedStreamingDataPipe
from data_rvt.utils.types import DatasetMode, DatasetType
...
def get_sequences(path: Path, dataset_config: DictConfig, guarantee_labels: bool) -> List[SequenceForIter]:
    ...
    ### extract settings from config_rvt ###
